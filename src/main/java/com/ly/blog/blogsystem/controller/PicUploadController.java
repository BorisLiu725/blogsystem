...
import com.ly.blog.blogsystem.service.PicService;
import com.ly.blog.blogsystem.utils.FileUploadResult;
...
public class PicUploadController {
    ...
    public FileUploadResult upload(@RequestParam("uploadFile")MultipartFile uploadFile) throws IOException {
        ...
        //保存图片的路径
        String picUrl = picProperties.getUrl() +  StringUtils.replace(StringUtils.substringAfter(filePath,picProperties.getUploadPath()),"\\","/");
